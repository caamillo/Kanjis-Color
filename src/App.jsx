...
function App() {
  ...
  return (
    <div className="w-screen h-screen bg-[#353734] flex flex-col justify-center relative items-center">
      <button style={isClicked ? { transform: 'scale(110%)' } : {}} onMouseDown={ () => setIsClicked(true) } onMouseUp={ () => setIsClicked(false) } className='bg-white transition-transform hover:scale-95 mb-5 px-3 py-2 rounded-md' onClick={ () => setOpen(tempOpen => !tempOpen) }>Change Color</button>
